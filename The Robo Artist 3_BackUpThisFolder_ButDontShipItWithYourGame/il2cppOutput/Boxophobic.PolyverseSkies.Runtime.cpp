...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void PolyverseSkies_Update_mBD57365D6E97AA4DFFBFCDBB0963E14EB0297FC1 (PolyverseSkies_tCBF44FF5F973FFBCE63399C6D8F62033E4312B3C* __this, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		Shader_SetGlobalVector_m885C9E39C787CA6F54E002C12E3D4280C353E438(_stringLiteralDEE1AC849B8C8CEFDEC6328594832A8135D2135C, L_6, NULL);
		goto IL_0048;
	}
...
IL_0034:
	{
		...
		Shader_SetGlobalVector_m885C9E39C787CA6F54E002C12E3D4280C353E438(_stringLiteralDEE1AC849B8C8CEFDEC6328594832A8135D2135C, L_8, NULL);
	}
...
IL_0048:
	...
	}
	{
		...
		Shader_SetGlobalVector_m885C9E39C787CA6F54E002C12E3D4280C353E438(_stringLiteral47D219E9F2B65C04D5F1A87D6E942CFEB82E383E, L_15, NULL);
		goto IL_0090;
	}
...
IL_007c:
	{
		...
		Shader_SetGlobalVector_m885C9E39C787CA6F54E002C12E3D4280C353E438(_stringLiteral47D219E9F2B65C04D5F1A87D6E942CFEB82E383E, L_17, NULL);
	}
...
IL_0090:
	...
	}
	{
		...
		RenderSettings_set_skybox_mC520BDF769C5B2824BE2CCC4ADC9CEBEE17A60B4(L_24, NULL);
	}
